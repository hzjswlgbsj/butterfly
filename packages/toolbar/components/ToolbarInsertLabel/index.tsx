        ...
        <InsertLabelWrapper width={labelWidth} >
          <InsertLeftIconWrapper>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <circle cx="12" cy="12" r="8.375" stroke="#454D5A" strokeWidth="1.25"></circle>
              <path fillRule="evenodd" clipRule="evenodd" d="M12 3a9 9 0 110 18 9 9 0 010-18zm0 1.25a7.75 7.75 0 100 15.5 7.75 7.75 0 000-15.5zm.61 7.119V8h-1.25v3.369L8 11.37v1.25l3.36-.001V16h1.25v-3.381l3.39.001v-1.25l-3.39-.001z" fill="#454D5A"></path>
            </svg>
          </InsertLeftIconWrapper>
